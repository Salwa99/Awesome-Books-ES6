...
## A solo programming project that heighlights the use of ES6.
...
- On the terminal run this command git clone https://github.com/Salwa99/Awesome-Books-ES6.git
...
- git clone https://github.com/Salwa99/Awesome-Books-ES6.git
